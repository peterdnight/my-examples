...
CsapCommon.httpPostJson = async function( url = '', data = {} ) {
...
CsapCommon.httpPostForm = async function( url = '', data = {} ) {
...
CsapCommon.httpDelete = async function( url = '', data = {} ) {
    // Default options are marked with *
    const response = await fetch( url, {
